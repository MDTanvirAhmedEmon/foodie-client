...
const OrderDetails = () => {
    ...
    return (
        <div className="bg-slate-100 mx-3 md:mx-0 mt-6 rounded-md p-8 md:mt-10 flex flex-col md:flex-row justify-center gap-10 items-center mb-4 md:mb-10 ">
            <div className="flex flex-col md:flex-row gap-10 ">
                {
                    data?.data?.product.map(pd => <SingleOrderBurger key={pd._id} product={pd}></SingleOrderBurger>)
                }
            </div>
            <div className="bg-slate-200 rounded-md p-10 font-semibold">
                <p className="">Order Date: {day}/{month}/{year}</p>
